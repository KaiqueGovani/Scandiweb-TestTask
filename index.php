...
<body>
        ...
        <nav class="navbar">
            <div class="container-fluid">
                ...
                <div class="navbaropts">
                    <div class="add">
                        <button class="btn btn-outline-success" type="button" onclick="location.href='add-product.php'">ADD</button>
                    </div>
                            <!-- Create the "MASS DELETE" button to delete all the selected products-->
                    <div class="delete">
                        <button class="btn btn-outline-danger"form="delete-form" type="submit" value="Delete Selected Products">MASS DELETE</button>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <!-- Page Content -->
    <div class="main">
        <form id="delete-form" method="post" action="delete-products.php">
